...
if pagina == "Cadastro/Editar Viagem":
    ...
    for campo in campos:
        if campo not in registro:
            registro[campo] = "" if "diesel" not in campo and "quantidade" not in campo else 0.0
    ...
    with st.form("form_cadastro"):
        ...
        with col6:
            ...
            transbordo = st.selectbox("Transbordo", options=["Nenhum", "Recebeu", "Passou"], index=0 if not registro["transbordo"] else ["Nenhum", "Recebeu", "Passou"].index(registro["transbordo"]))
            ...
            de_ou_para = st.text_input("De/Para (Barco envolvido)", value=registro["de_ou_para"])

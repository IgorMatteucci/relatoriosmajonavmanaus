...
SHEET_URL = "https://docs.google.com/spreadsheets/d/1GwZEeD1Fk4toqIit5qzXyokJzaZRJmH-g47R9JV2jXA/edit?usp=sharing"
...
# --- Autenticação via st.secrets (NÃO usa arquivo json físico!)

...
if pagina == "Cadastro/Editar Viagem":
    ...
    with st.form("form_cadastro"):
        ...
        with col2:
            ...
            data_saida_belem = st.date_input("Data Saída Belém", value=parse_date(get_registro("data_saida_belem", "")))
        ...
        with col3:
            data_chegada_manaus = st.date_input("Data Chegada Manaus", value=parse_date(get_registro("data_chegada_manaus", "")))
        ...
        with col5:
            ...
            data_saida_manaus = st.date_input("Data Saída Manaus", value=parse_date(get_registro("data_saida_manaus", "")))
        ...
        with col6:
            ...
            sasaldo_diesel_atual = st.number_input("Saldo Diesel Atual (L)",min_value=0.0,format="%.0f",value=sanitize_number(registro["saldo_diesel_atual"]))
